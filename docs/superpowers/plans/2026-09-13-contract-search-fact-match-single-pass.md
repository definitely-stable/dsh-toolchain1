...
- Original stacked validation base: `0248346eccc49d13b746771c9ea5906bfc860013` (PR #219 head).
- Final restack base after #219 merge: `b436d654d86b67178d7c9815a3aaa65596b52168` (`main`).
...
- [x] Restack directly onto `main` after PR #219 integration.
