...
- [x] Dedicated fast-path regression run `34737177035` completed successfully after correcting the fixture to exercise the fact lane rather than the identity lane.
...
- [x] PR #219 integrated and this branch restacked directly onto `main@b436d654d86b67178d7c9815a3aaa65596b52168`.
- [ ] Re-run full CI, Performance Validation, and Real Plugin Corpus on the final PR head.
