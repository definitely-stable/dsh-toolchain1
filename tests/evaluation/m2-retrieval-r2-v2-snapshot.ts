...
export const R2_V2_BASELINE_RANKER_VERSION = 'dsh-contract-search-v2-intent'
export const R2_V2_BASELINE_CORPUS_FINGERPRINT = 'dsh-contract-search-r2-dev-v1:f2ba02022f1567a3ab748d8182e113d63773556020ab70f3738299645ef4e1b4'

export const R2_V2_BASELINE_RESULTS: readonly R2RankedResult[] = Object.freeze([
  ...
  { taskId: 'r2-sibling-compaction-pruner', rankedContractIds: ['package:@deepseek-ai/dsh-client-runtime'] },
  { taskId: 'r2-sibling-bash-sandbox', rankedContractIds: ['package:@deepseek-ai/dsh-bash-local'] },
  ...
  { taskId: 'r2-version-drift-session-vnext-api', rankedContractIds: ['package:@deepseek-ai/dsh-api-remotes'] },
