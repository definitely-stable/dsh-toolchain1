...
export const R2_FIELDED_IDF_BASELINE_RANKER_VERSION = 'dsh-contract-search-v3-fielded-idf'
export const R2_FIELDED_IDF_BASELINE_CORPUS_FINGERPRINT = 'dsh-contract-search-r2-dev-v1:f2ba02022f1567a3ab748d8182e113d63773556020ab70f3738299645ef4e1b4'
export const R2_FIELDED_IDF_BASELINE_COMMIT = 'df1b7f7770fe3c4507fb53cc80ce6b8d5a166f9a'

export const R2_FIELDED_IDF_BASELINE_RESULTS: readonly R2RankedResult[] = Object.freeze([
